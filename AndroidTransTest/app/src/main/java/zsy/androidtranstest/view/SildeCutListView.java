package zsy.androidtranstest.view;
...
public class SildeCutListView extends ListView {
    ...
    public SildeCutListView(Context context, AttributeSet attrs, int defStyle) {
...
//                        //双击事件
//                        Log.v("secClick - firClick","< 500");
//                        Toast.makeText(this.getContext(), "响应双击事件",
